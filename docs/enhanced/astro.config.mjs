...
//   /menuapi/enhanced (canonical) and /mapi/enhanced (backwards compatibility).
const BASE = process.env.DOCS_BASE || '/menuapi/enhanced';
...
export default defineConfig({
  ...
  integrations: [
    starlight({
      title: 'MenuAPI (FiveM Enhanced)',
      description: 'Documentation for MenuAPI, an advanced C# menu API for FiveM (Enhanced).',
      favicon: '/favicon.png',
      ...
      sidebar: [
          ...
          items: [
            ...
            { label: 'Key bindings', link: '/reference/keybindings/' },
            {
              ...
              items: [
                ...
                { label: 'SeparatorMenuItem', link: '/reference/menuitems/separatormenuitem/' },
              ],
            },
        ...
        { label: 'Changelog', link: '/changelog/' },
        {
          ...
          items: [
            ...
            { label: 'NuGet', link: 'https://www.nuget.org/packages/MenuAPI.FiveM.Enhanced/', attrs: { target: '_blank' } },
