...
//   /menuapi/redm (canonical) and /mapi/redm (backwards compatibility).
const BASE = process.env.DOCS_BASE || '/menuapi/redm';
...
export default defineConfig({
  ...
  integrations: [
    starlight({
      title: 'MenuAPI (RedM)',
      description: 'Documentation for MenuAPI on RedM, a FiveM and RedM C# menu API.',
      favicon: '/favicon.png',
