...
:::note
Icon availability is more limited in RedM than in FiveM, so some of the icons listed below may not be available. The RedM icons are listed at the bottom of the table.
:::
