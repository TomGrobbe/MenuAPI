...
namespace MenuAPI.NativeHooks;

/// <summary>
/// Runs around every <em>Native.*</em> call in MenuAPI, through the forwarder class that
/// MenuAPI.NativeHooks.Generator emits. Only the NativeHooks configuration builds it,
